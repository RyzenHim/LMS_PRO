      ...
      <div className="relative hidden lg:flex flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-16 text-white">
          <div className="space-y-1">
            <h1 className="text-3xl font-bold tracking-wide">LMS Portal</h1>
          ...
          <div className="max-w-lg space-y-8">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              A next-generation learning management system designed for
              institutions, instructors, and enterprise teams to deliver
              world-class education experiences.
            </p>
